...
🧠 Deep Learning     → CNNs, RNNs, Transformers, Fine-tuning
☁️  Cloud Deployment  → Docker, AWS/GCP basics, Model Serving
🗄️  Vector Databases  → Chroma, FAISS, Pinecone, Weaviate
🔍 Advanced RAG      → Hybrid Search, Re-ranking, Eval Pipelines
```
